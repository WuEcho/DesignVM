...
var (
	...
	TestChainConfig = &ChainConfig{big.NewInt(1),nil,  new(EthashConfig), nil,nil}
)
...
type ChainConfig struct {
	...
	//vm type
	MetaVM *MetaVMConfig `json:"meta_vm"`
}

type MetaVMConfig struct {}

func (m *MetaVMConfig) String() string {
	return "metavm"
}
