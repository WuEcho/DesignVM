...
type (
	executionFunc func(pc *uint64, interpreter *VMInterpreter, callContext *ScopeContext) ([]byte, error)
	gasFunc       func(*ETHVM, *Contract, *Stack, *Memory, uint64) (uint64, error) // last parameter is the requested memory size as a uint64
